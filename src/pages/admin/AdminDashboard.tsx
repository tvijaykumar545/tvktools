...
import { Users, BarChart3, Wrench, Shield, FileText, Coins, Mail, Palette, Key, Activity } from "lucide-react";
    ...
    <div className="cyber-grid min-h-screen py-8">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-8 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <Link to="/admin/purchases" className="flex items-center gap-3 rounded border border-yellow-500/20 bg-card p-4 transition-all hover:border-yellow-500/50 border-glow">
            <Coins className="h-5 w-5 text-yellow-500" />
            <span className="font-heading text-xs font-semibold text-foreground">Purchase Approvals</span>
          </Link>
          ...
          <Link to="/admin/api-management" className="flex items-center gap-3 rounded border border-secondary/20 bg-card p-4 transition-all hover:border-secondary/50 neon-glow-magenta">
